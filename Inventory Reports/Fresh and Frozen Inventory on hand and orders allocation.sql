...
FROM		FISH1.dbo.IV00101 AS ITMMAST  WITH (NOLOCK)
	...
	FULL OUTER JOIN	#QTYALC102120201325	AS QTYALLOC ON QTYALLOC.itemNum = ITMMAST.ITEMNMBR AND QTYALLOC.UOMSCHDL = ITMMAST.UOMSCHDL
	FULL OUTER JOIN #INT102320201326 AS INTRANSIT ON INTRANSIT.[ITEM NUM] = ITMMAST.ITEMNMBR
